        ...
        <div class="formulario">
            <div class="figuras1" background="image/fondo.gif">
                <div class="imageFigura" background="image/fondo.gif">
                    <a href="servlet?control=trapecio"><img src="image/trapecio.png" alt="Imagen Trapecio" class="geometrica"></a>
                </div>
                <div class="imageFigura" background="image/fondo.gif">
                    <a href="servlet?control=trapecioP"><img src="image/trapecio.png" alt="Imagen Trapecio" class="geometrica"></a>
                </div>
            </div>
