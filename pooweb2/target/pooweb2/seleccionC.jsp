        ...
        <div class="formulario">
            <div class="figuras1" background="image/fondo.gif">
                <div class="imageFigura" background="image/fondo.gif">
                    <a href="servlet?control=circulo"><img src="image/circle.png" alt="Imagen Circulo" class="geometrica"></a>
                </div>
                <div class="imageFigura" background="image/fondo.gif">
                    <a href="servlet?control=circuloP"><img src="image/circle.png" alt="Imagen Circulo" class="geometrica"></a>
                </div>
            </div>
